  ...
  <div class="content-wrapper" style="left: 300px; flex-direction: row; ">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <select name="category">
                         <c:forEach items="${category }" var="cate">
                          ...
                          <div class="btn-group" style="width: 150px;">
                            ...
                            <a class="dropdown-item" name = "category" href="javascript:void(0);" >${cate }</a>
                             ...
                             <button
                              ...
                              aria-expanded="false"> 카테고리선택  </button>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" name = "category" href="javascript:void(0);" >DG</a></li>
                      ...
                      <div class="mb-3 row">
                        ...
                        <a class="dropdown-item" name="classLimit" href="javascript:void(0);">1</a>
                        <!--  
                          <div class="btn-group" style="width: 150px;">
                            <button type="button" 
                              class="btn btn-outline-primary dropdown-toggle"
                              data-bs-toggle="dropdown"
                              aria-expanded="false">인원선택</button>
                            <ul class="dropdown-menu">
                              <li></li>
                      ...
                      <div class="mb-3 row">
                        ...
                        <a class="dropdown-item" name = "products" href="javascript:void(0);">0</a>
                         <!--  
                          <div class="btn-group" style="width: 150px;">
                            <button
                              type="button"
                               class="btn btn-outline-primary dropdown-toggle"
                              data-bs-toggle="dropdown"
                              aria-expanded="false">준비물유무</button>
                            <ul class="dropdown-menu">
                              <li></li>
	...
	<script>
		$("#subBtn").on("click",function(){
			...
			//const files = $("input[name=files]").files[0];
			const teacherName = $("input[name=teacherName]").val();
			const teacerIntroduce = $("input[name=teacherIntroduce]").val();
			const curriculum =$("input[name=curriculum]").val();
			const startDate = $("input[name=startDate]").val();
			const endDate = $("input[name=endDate]").val();
			const category = $("a[name=category]").text();
			const classLimit = $("a[name=classLimit]").text();
			const products = $("a[name=products]").text();
			...
			formData.append('teacerIntroduce',teacerIntroduce);
